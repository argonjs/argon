...
declare module 'cesium' {
    ...
    class ConstantPositionProperty {
        ...
        constructor(value?: Cartesian3, referenceFrame?: ReferenceFrame | Entity);
        getValue(time: JulianDate, result?: any): any;
        setValue(value?: Cartesian3, referenceFrame?: ReferenceFrame | Entity);
        getValueInReferenceFrame(time: JulianDate, referenceFrame: ReferenceFrame | Entity, result?: Cartesian3): Cartesian3;
        equals(other?: Property): boolean;
    }
    ...
    class ReferenceEntity {
        ...
        constructor(targetCollection: EntityCollection, targetId: string);
    }
    ...
    class SampledPositionProperty {
        ...
        constructor(referenceFrame?: ReferenceFrame | Entity, numberOfDerivatives?: number);
        getValue(time: JulianDate, result?: Cartesian3): Cartesian3;
        getValueInReferenceFrame(time: JulianDate, referenceFrame: ReferenceFrame | Entity, result?: Cartesian3): Cartesian3;
        ...
        // Note: Added by Argon
        removeSamplesBeforeDate(time: JulianDate);
    }
    ...
    class SampledProperty {
        ...
        definitionChanged: Event;
        type: any;
        derivativeTypes: (typeof Packable)[];
        interpolationDegree: number;
        interpolationAlgorithm: InterpolationAlgorithm;
        forwardExtrapolationType: ExtrapolationType;
        forwardExtrapolationDuration: number;
        backwardExtrapolationType: ExtrapolationType;
        backwardExtrapolationDuration: number;
        constructor(type: number | (typeof Packable), derivativeTypes?: (typeof Packable)[]);
        getValue(time: JulianDate, result?: any): any;
        setInterpolationOptions(options?: { interpolationAlgorithm?: InterpolationAlgorithm; interpolationDegree?: number });
    ...
    class TimeIntervalCollectionPositionProperty {
        ...
        intervals: TimeIntervalCollection;
        referenceFrame: ReferenceFrame | Entity;
        constructor(referenceFrame?: ReferenceFrame | Entity);
        getValue(time: JulianDate, result?: any): any;
        getValueInReferenceFrame(time: JulianDate, referenceFrame: ReferenceFrame | Entity, result?: Cartesian3): Cartesian3;
        equals(other?: Property): boolean;
    }
    ...
    class Packable {
        static packedLength: number;
        static pack(value: any, array: number[], startingIndex?: number);
        static unpack(array: number[], startingIndex?: number, result?: any);
    }
    ...
    module Transforms {
        ...
        // Note: Declared as private, but used by Argon
        var iau2006XysData: any; // TODO: should be type Iau2006XysData
    }
