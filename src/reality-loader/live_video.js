System.register(['aurelia-dependency-injection', '../common', '../session', '../reality', '../view', '../vuforia', '../utils'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            LiveVideoRealityLoader = (function (_super) {
                ...
                LiveVideoRealityLoader = __decorate([
                    aurelia_dependency_injection_1.inject(session_1.SessionService, view_1.ViewService, vuforia_1.VuforiaServiceDelegate)
