// These declarations are used for importing modules resolved by JSPM
// (default exports are used because JSPM exposes non-esm mdules via the default export)
...
declare module 'Cesium/Source/Core/createGuid' {
    import * as Cesium from 'Cesium';
    export default Cesium.createGuid;
}
...
declare module 'Cesium/Source/Core/Math' {
    import * as Cesium from 'Cesium';
    export default Cesium.CesiumMath;
}
...
declare module 'Cesium/Source/DataSources/OrientationProperty' {
    import * as Cesium from 'Cesium';
    export default Cesium.OrientationProperty;
}
...
declare module 'Cesium/Source/DataSources/ReferenceEntity' {
    import * as Cesium from 'Cesium';
    export default Cesium.ReferenceEntity;
}
