...
var processFrameState = function (suggestedFrameState) {
    app.device.requestFrameState().then(processFrameState);
    var frameState = app.device.createFrameState(suggestedFrameState.time, suggestedFrameState.viewport, suggestedFrameState.subviews, app.context.user);
